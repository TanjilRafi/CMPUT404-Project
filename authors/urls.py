...
urlpatterns = [
    ...
    # POST inbox
    path('api/authors/<uuid:id>/inbox/', api_views.api_inbox, name='api_inbox_slash'),
    path('api/authors/<uuid:id>/inbox', api_views.api_inbox, name='api_inbox_no_slash'),
    ...
    path('friends/<uuid:id>', template_views.my_friends, name='friends'),
    ...
    path('api/authors/<uuid:id>/entries/', api_views.ApiEntries.as_view(), name='api_entries'),

    # PUT + DELETE for RESTful practice
    path('api/authors/<uuid:id>/entries/<uuid:post_id>/', api_views.ApiEntryDetail.as_view(), name='api_entry_detail'),
    ...
    path('api/authors/<uuid:id>/following/<path:fqid>/', api_views.api_following),

    # GET, PUT, DELETE to handle followers
    path('api/authors/<uuid:id>/followers/<path:fqid>', api_views.ApiFollowers.as_view(), name='api_followers'),

    # GET list of following
    path('api/authors/<uuid:id>/following/', api_views.api_following_list, name='api_following_list'),
    path('api/authors/<uuid:id>/following', api_views.api_following_list, name='api_following_list_no_slash'),
    ...
    # Commented API
    path('api/authors/<uuid:author_id>/commented/', api_views.ApiAuthorCommented.as_view(), name='api_author_commented'),
    ...
    path('api/authors/<uuid:author_id>/liked/<uuid:like_id>/', api_views.api_single_like, name='api_single_like'),
    path('api/authors/<path:fqid>/liked/', api_views.api_author_liked_fqid, name='api_author_liked_fqid'),
    path('api/liked/<path:fqid>/',api_views.api_single_like_fqid, name='api_single_like_fqid'),
    
    # Comment Likes
    path('api/authors/<uuid:author_id>/entries/<uuid:post_id>/comments/<path:comment_fqid>/likes', api_views.api_comment_likes, name='api_comment_likes'),
    path('api/authors/<uuid:author_id>/entries/<uuid:post_id>/comments/<path:comment_fqid>/likes/', api_views.api_comment_likes),
    
    # GET single author using fqid
    path('api/authors/<path:fqid>/', api_views.api_author_profile_fqid, name='api_author_profile_fqid'), 

    # GET entry by fqid
    path('api/entries/<path:fqid>/', api_views.api_entry_fqid, name='api_entry_fqid'),
    
    # Discover remote authors from other nodes
    path('discover/', template_views.discover, name='discover'),
